...
export default {
  ...
  methods:{
    confimxd(){
     //console.log(this.$store.dispatch('dconfirm/showConfirmDialog',{title:'hey ',content:'contenido hdp'}));
      //  this.$confirm({ message: 'Are you sure you want to do this?', confirm: 'Yes!', cancel: 'Hell no' }).then(console.log);
